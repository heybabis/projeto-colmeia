...
public class CentroDeDistribuição implements Serializable {
	...
	public CentroDeDistribuição(Long id, List<Endereco> enderecos) {
		this.id = id;
		this.enderecos = enderecos;
	}

	public CentroDeDistribuição(Long id, List<Funcionario> funcionarios, List<Endereco> enderecos) {
		this.id = id;
	...
	public boolean equals(Object object) {
		...
		CentroDeDistribuição that = (CentroDeDistribuição) object;
